...
import { Camera, Loader, MapPin, LaptopMinimalCheck, Shuffle } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <textarea
                ...
                placeholder="Introduce yourself and explain your goals for learning a new language"
              />
            </div>
            ...
            <button className="btn btn-primary w-full" disabled={isPending} type="submit">
              {!isPending ? (
                <>
                  <LaptopMinimalCheck className="size-5 mr-2" />
                  Complete Onboarding
                </>
              ) : (
                <>
